...
class GeneralizedIF(bp.NeuGroup):
    """Generalized Integrate-and-Fire model (GeneralizedIF model) [1]_.
    ...
    **Variables name** **Initial Value** **Explanation**
    ...
    def derivative(I1, I2, V_th, V, t,
                   k1, k2, a, V_rest, b, V_th_inf, R, I_ext, tau):
        dI1dt = - k1 * I1
        dI2dt = - k2 * I2
    ...
    def __init__(self, size, V_rest=-70., V_reset=-70.,
        ...
        # vars
        self.I1 = bp.ops.zeros(self.num)
        self.I2 = bp.ops.zeros(self.num)
        self.V = bp.ops.ones(self.num) * -70.
        self.V_th = bp.ops.ones(self.num) * -50.
