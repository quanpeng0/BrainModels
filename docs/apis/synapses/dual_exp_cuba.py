# -*- coding: utf-8 -*-
# %% [markdown]
# # Simple Example of Current-based Dual Exponential Synapse
# %%
...
syn1 = brainmodels.synapses.DualExpCUBA(neu1, neu2, bp.connect.All2All(), monitors=['g', 'h'])
...
plt.plot(neu1.mon.ts, syn1.mon.h, label='h')
plt.legend()
plt.show()
